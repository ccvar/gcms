...
var themeDescEN = map[string]string{
	...
	"answer-desk":               "Search-first Q&A homepage with a featured answer, popular questions and topic navigation",
	"answer-desk-white":         "Answer Desk on a pure-white canvas",
	"answer-desk-dark":          "Answer Desk on a deep navy canvas",
	"portrait-journal":          "People-led interviews and profiles with a lead portrait, profile archive and recent conversations",
	"portrait-journal-white":    "Portrait Journal on a pure-white canvas",
	"portrait-journal-dark":     "Portrait Journal on a deep forest canvas",
	"casebook":                  "Case-study homepage with a flagship case, industry index, modular case stories and recent ledger",
	"casebook-white":            "Casebook on a pure-white canvas",
	"casebook-dark":             "Casebook on a deep charcoal canvas",
	"shelf-index":               "Image-led knowledge shelves with a featured reading band and compact index",
	"shelf-index-white":         "Shelf Index on a pure-white canvas",
	"shelf-index-dark":          "Shelf Index on a deep navy canvas",
	"tradeoff-sheet":            "Decision worksheet with a current focus, category lenses and article ledger",
	"tradeoff-sheet-white":      "Tradeoff Sheet on a pure-white canvas",
	"tradeoff-sheet-dark":       "Tradeoff Sheet on a deep umber canvas",
	"progress-bulletin":         "Chronological bulletin with a current issue, category index and dated ledger",
	"progress-bulletin-white":   "Progress Bulletin on a pure-white canvas",
	"progress-bulletin-dark":    "Progress Bulletin on a deep night canvas",
	"margin-reading-room":       "Research reading room with lenses, companion reading and an annotated index",
	"margin-reading-room-white": "Margin Reading Room on a pure-white canvas",
	"margin-reading-room-dark":  "Margin Reading Room on a deep forest canvas",
	"light-table":               "Visual discovery homepage with an image-led hero and four-column contact sheet",
	"light-table-white":         "Light Table on a pure-white canvas",
	"light-table-dark":          "Light Table on a darkroom canvas",
	"counterpoint":              "Paired-reading homepage with a premise band and two neutral content paths",
	"counterpoint-white":        "Counterpoint on a pure-white canvas",
	"counterpoint-dark":         "Counterpoint on a deep navy canvas",
	"seamless-canvas":           "Continuous media-led first screen shared by the hero, logo, navigation and category index",
	"seamless-canvas-white":     "Seamless Canvas on a pure-white content canvas",
	"seamless-canvas-dark":      "Seamless Canvas on a deep shadow content canvas",
	"night-corridor":            "Immersive media hero with integrated navigation, a reading guide and bottom content track",
	"night-corridor-white":      "Night Corridor on a pure-white content canvas",
	"night-corridor-dark":       "Night Corridor on a deep black content canvas",
	"open-ascent":               "Bright media-led first screen with integrated navigation, article rows and featured reading",
	"open-ascent-white":         "Open Ascent on a pure-white content canvas",
	"open-ascent-dark":          "Open Ascent on a deep navy content canvas",
	"toolbench":                 "Developer workbench combining recommended tools, comparison entrances and latest updates",
	"toolbench-white":           "Toolbench on a pure-white canvas",
	"decision-grid":             "Scenario-first decision dashboard for discovering tools, opening comparisons and tracking updates",
	"decision-grid-white":       "Decision Grid on a pure-white canvas",
	"release-radar":             "Update-led developer briefing with tool recommendations and selection comparisons",
	"release-radar-white":       "Release Radar on a pure-white canvas",
...
func (s *Server) adminSaveAppearance(w http.ResponseWriter, r *http.Request) {
	...
	if r.FormValue(themeOptsFormMarker) != "" {
