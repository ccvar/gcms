...
func platformSkillMarkdown(apiBase string) string {
	...
	return strings.Join([]string{
		...
		"- `node scripts/gcms.js page-publish --site blog 42 --revision-id 5 --build-id 7 --etag '<copy _protocol.etag verbatim>' --request-id page-publish-005 --confirm true`（Pilot 原生界面确认）",
