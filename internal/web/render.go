...
func NewRenderer(tplFS fs.FS, imageSizes map[string]ImageSize) (*Renderer, error) {
	...
	partials := []string{"layout.html", "partials/head.html", "partials/header.html", "partials/footer.html", "partials/home_bento.html", "partials/home_index.html", "partials/home_split.html", "partials/home_axis.html", "partials/home_bands.html", "partials/home_ticker.html", "partials/home_board.html", "partials/home_timeline.html", "partials/home_liftoff.html", "partials/home_deck.html", "partials/home_poster.html", "partials/home_uptime.html", "partials/home_profile.html", "partials/home_bloom.html", "partials/home_desktop.html", "partials/home_cinema.html", "partials/home_collage.html", "partials/home_constellation.html"}
	...
	tp, err := template.New("theme_preview").Funcs(funcMap(imageSizes)).ParseFS(sub, "theme_preview.html", "partials/home_bento.html", "partials/home_index.html", "partials/home_split.html", "partials/home_axis.html", "partials/home_bands.html", "partials/home_ticker.html", "partials/home_board.html", "partials/home_timeline.html", "partials/home_liftoff.html", "partials/home_deck.html", "partials/home_poster.html", "partials/home_uptime.html", "partials/home_profile.html", "partials/home_bloom.html", "partials/home_desktop.html", "partials/home_cinema.html", "partials/home_collage.html", "partials/home_constellation.html")
	if err != nil {
		return nil, err
	}
	r.sets["theme_preview"] = tp

	for _, name := range []string{"login", "dashboard", "posts", "edit", "settings", "pages", "links", "visual", "sites", "platform_settings", "platform_automation", "backups", "archived_sites", "updates", "admin_i18n", "security", "extensions", "ext_list", "ext_edit", "ext_archive", "ext_type_edit"} {
