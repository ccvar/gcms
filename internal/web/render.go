...
func NewRenderer(tplFS fs.FS, imageSizes map[string]ImageSize) (*Renderer, error) {
	...
	for _, name := range []string{"login", "dashboard", "posts", "edit", "settings", "pages", "links", "visual", "sites", "platform_settings", "backups", "archived_sites", "updates", "admin_i18n", "security"} {
