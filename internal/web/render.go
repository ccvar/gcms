...
func NewRenderer(tplFS fs.FS, imageSizes map[string]ImageSize) (*Renderer, error) {
	...
	for _, name := range []string{"login", "dashboard", "posts", "edit", "settings", "pages", "page_new", "page_composer", "links", "visual", "sites", "pilot_console", "platform_settings", "platform_automation", "backups", "archived_sites", "media_cleanup", "updates", "admin_i18n", "security", "extensions", "ext_list", "ext_edit", "ext_archive", "ext_type_edit"} {
