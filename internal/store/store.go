...
func (s *Store) normalizeShowcaseDefaults() error {
	...
	updates := []struct {
		...
		{"site.description", "gcms 是面向产品官网、技术文档和轻量内容站的自托管 CMS：单个二进制启动，SQLite 单文件存储，服务端渲染默认做好 SEO，多语种、主题、在线升级和自动化接口开箱可用。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站。自带后台、主题、多语种、SEO、在线升级和自动化接口，下载即可运行。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站：单个二进制启动，SQLite 单文件存储，低配 VPS 也能部署；后台、主题、多语种、SEO、在线升级和自动化接口开箱可用。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站：单个二进制启动，SQLite 单文件存储，低配 VPS 也能部署；后台、主题、多语种、SEO、在线升级都开箱可用，并支持 AI 协助运营。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站：单个二进制启动，SQLite 单文件存储，小规格 VPS 也能部署；后台、主题、全语种内容、SEO、在线升级和 AI 运营都开箱可用。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站：单个二进制启动，SQLite 单文件存储，小规格 VPS 也能部署；后台、主题、全语种内容、SEO、在线升级和 AI 自运营接口都开箱可用。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 适合产品官网、技术文档、资源导航和轻量内容站：单个二进制启动，SQLite 单文件存储，小规格 VPS 也能部署；后台、主题、全语种内容、SEO/GEO、在线升级和 AI 自运营接口都开箱可用。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 把内容发布、全语种管理、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；单个二进制加 SQLite 文件即可部署，适合小团队把官网、文档和资源站长期跑稳。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.description", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；单个二进制加 SQLite 文件即可部署，小团队也能长期维护。", "gcms 把文章、页面、资源链接、全语种内容、主题、SEO/GEO、在线升级和 AI 自运营接口收进同一个后台；无需搭数据库服务和前端构建环境，一行命令即可部署，1 vCPU / 512MB 内存的小规格 VPS 也能稳定起步。"},
		{"site.hero_eyebrow", "产品官网 · 技术文档 · 自托管内容站", "轻部署 · SEO/GEO 就绪 · AI 自运营"},
		{"site.hero_eyebrow", "产品官网 · 技术文档 · 资源导航 · 轻量内容站", "轻部署 · SEO/GEO 就绪 · AI 自运营"},
		{"site.hero_eyebrow", "低配置部署 · SEO 就绪 · 自托管内容站", "轻部署 · SEO/GEO 就绪 · AI 自运营"},
		{"site.hero_eyebrow", "轻部署 · SEO 就绪 · 全语种覆盖", "轻部署 · SEO/GEO 就绪 · AI 自运营"},
		{"site.hero_eyebrow", "轻部署 · SEO/GEO 就绪 · 全语种覆盖", "轻部署 · SEO/GEO 就绪 · AI 自运营"},
		...
		{"site.description::en", "gcms is a self-hosted CMS for product sites, docs and lightweight content hubs: one binary to run, SQLite as a single-file store, server-rendered SEO by default, with multilingual content, themes, in-app updates and automation APIs built in.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms fits product sites, docs, resource directories and lightweight content hubs. It ships with an admin, themes, multilingual content, SEO, in-app updates and automation APIs, ready to run after download.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms fits product sites, docs, resource directories and lightweight content hubs: one binary, one SQLite file, deployable on a low-end VPS, with admin, themes, multilingual content, SEO, in-app updates and automation APIs out of the box.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms fits product sites, docs, resource directories and lightweight content hubs: one binary, one SQLite file, deployable on a low-end VPS, with admin, themes, multilingual content, SEO, in-app updates and AI-assisted operations out of the box.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms fits product sites, docs, resource directories and lightweight content hubs: one binary, one SQLite file, deployable on small VPS instances, with admin, themes, multilingual content, SEO, in-app updates and AI operations out of the box.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms fits product sites, docs, resource directories and lightweight content hubs: one binary, one SQLite file, deployable on small VPS instances, with admin, themes, multilingual content, SEO/GEO, in-app updates and AI operations out of the box.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms brings publishing, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. Deploy one binary with one SQLite file, then keep product sites, docs and resource hubs easy to maintain.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.description::en", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. Deploy one binary with one SQLite file, then keep content operations easy to maintain.", "gcms brings posts, pages, resource links, multilingual content, themes, SEO/GEO, in-app updates and AI-operation APIs into one lightweight admin. No database server or frontend build pipeline required: deploy with one command and start on a 1 vCPU / 512MB VPS."},
		{"site.hero_eyebrow::en", "Product sites · Docs · Self-hosted content", "Self-hosted · SEO/GEO-ready · AI operations"},
		{"site.hero_eyebrow::en", "Product sites · Docs · Resource directories · Content hubs", "Self-hosted · SEO/GEO-ready · AI operations"},
		{"site.hero_eyebrow::en", "Low-resource deploys · SEO-ready · Self-hosted CMS", "Self-hosted · SEO/GEO-ready · AI operations"},
		{"site.hero_eyebrow::en", "Easy deploy · SEO-ready · Multilingual", "Self-hosted · SEO/GEO-ready · AI operations"},
		{"site.hero_eyebrow::en", "Easy deploy · SEO/GEO-ready · Multilingual", "Self-hosted · SEO/GEO-ready · AI operations"},
